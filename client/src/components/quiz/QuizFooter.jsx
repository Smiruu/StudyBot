...
const QuizFooter = ({ currentQuestion, totalQuestions, onNav, onSubmit, isSubmitDisabled }) => {
    return (
        <div className="flex flex-col sm:flex-row items-center justify-between pt-10 pb-4">
            ...
            <div className="flex gap-4 w-full sm:w-auto justify-center mt-4 sm:mt-0">
                ...
                {currentQuestion < totalQuestions - 1 ? (
                    ...
                    <button className={`text-sm font-extrabold bg-tertiary text-on-tertiary px-8 py-3 rounded-full transition-all ${isSubmitDisabled ? 'opacity-50 cursor-not-allowed' : 'shadow-[0_4px_16px_rgba(243,192,26,0.2)] hover:shadow-[0_6px_24px_rgba(243,192,26,0.3)] hover:-translate-y-0.5'}`}
